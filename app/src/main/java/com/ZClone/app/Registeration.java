...
import com.ZClone.app.R;
import com.ZClone.app.ReusableCode.ReusableCodeForAll;
...
public class Registeration extends AppCompatActivity {
    ...
    String[] Maharashtra = {"Solapur","Mumbai", "Pune", "Aurangabad"};
    ...
    String[] Solapur = {"North Solapur", "South Solapur", "Barshi", "Mangalwedha", "Pandharpur"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            City.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (cityy.equals("Solapur")) {
                        ...
                        listt.addAll(Arrays.asList(Solapur));
                        ...
                        FAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    mDialog.dismiss();
                                    ReusableCodeForAll.ShowAlert(Registeration.this,"Error", Objects.requireNonNull(task.getException()).getMessage());
                                }
                            }
                        });
                    }
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Registeration.this);
                builder.setMessage("This Feature is currently unavailable ");
                builder.setCancelable(false);
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
