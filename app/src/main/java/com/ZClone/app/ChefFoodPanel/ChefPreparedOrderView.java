package com.ZClone.app.ChefFoodPanel;
...
import com.ZClone.app.Chef;

import com.ZClone.app.R;
import com.ZClone.app.SendNotification.APIService;
import com.ZClone.app.SendNotification.Client;
import com.ZClone.app.SendNotification.Data;
import com.ZClone.app.SendNotification.MyResponse;
import com.ZClone.app.SendNotification.NotificationSender;
            ...
            public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                if (response.code() == 200) {
                    if (response.body().success != 1) {
                        Toast.makeText(ChefPreparedOrderView.this, "", Toast.LENGTH_SHORT).show();
                    }
                }
